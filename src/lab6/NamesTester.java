...
/**
Unit test program for others.Names class
 ...
 */
 private static void testLookup() {
	System.out.println("Testing lookup method...");
     ...
     names.loadNames();
     System.out.println("others.Names in list: ");
     names.printNames();
 ...
 */
 private static void testInsert() {
	...
	System.out.println("Testing insert method...");
     ...
     System.out.println("others.Names in list [exp: <empty>]: ");
     names.printNames();
     System.out.println("Number of names in list [exp: 0]: " +
             names.numNames());	
 ...
 /**
    others.Test lookup of target in names, and prints results.
  */
 ...
 /**
    others.Test remove of goner on names, and prints actual and expected results.
 ...
 private static void doOneRemove(Names names, String goner, 
     ...
     System.out.println("others.Names in list [exp: " + expectedResult + "]: ");
     names.printNames();
 ...
 /**
    others.Test insert of newName on names, and prints actual and expected results.
    @param names the names object we are testing
 ...
 private static void doOneInsert(Names names,
     ...
     System.out.println("others.Names in list [exp: "
             + expectedResult + "]: ");
     names.printNames();
     System.out.println("Number of names in list [exp: "
             + expectedSize + "]: " +
