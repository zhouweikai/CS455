...
public class After7Tester {
	...
	/*
	 * Test hasPeak method on a list form of input given in listString Prints test
	 * data, result, expectedResult, and whether result matched expectedResult
	 *
	 ...
	 * etc.
	 *
	 * expectedResult needs to be given in List toString() format so we can compare
	 * it for equality to result.toString()
	 */
